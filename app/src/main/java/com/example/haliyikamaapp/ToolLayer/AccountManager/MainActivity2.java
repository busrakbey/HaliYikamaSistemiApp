		...
		public void run(AccountManagerFuture<Bundle> result) {
			...
			try {
				...
				if (null != intent) {
					...
					Account account = AccountUtils.getAccount(MainActivity2.this, accountName);
					if (null == account) {
						account = new Account(accountName, AccountUtils.ACCOUNT_TYPE);
						mAccountManager.addAccountExplicitly(account, bundle.getString(LoginActivity2.PARAM_USER_PASSWORD), null);
