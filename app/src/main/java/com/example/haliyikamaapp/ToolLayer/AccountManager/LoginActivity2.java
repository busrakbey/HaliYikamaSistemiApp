 ...
 * well.
 */
public class LoginActivity2 extends AccountAuthenticatorActivity {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Intent> {
		...
		protected Intent doInBackground(Void... params) {
			...
			String authToken = AccountUtils.mServerAuthenticator.signIn(mEmail, mPassword, getApplicationContext());
