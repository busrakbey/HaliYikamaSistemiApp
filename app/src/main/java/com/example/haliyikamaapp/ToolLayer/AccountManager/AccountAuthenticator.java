...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
	...
	throws NetworkErrorException
	{
		...
		intent.putExtra(LoginActivity2.ARG_ACCOUNT_TYPE, accountType);
		intent.putExtra(LoginActivity2.ARG_AUTH_TOKEN_TYPE, authTokenType);
		intent.putExtra(LoginActivity2.ARG_IS_ADDING_NEW_ACCOUNT, true);
	...
	throws NetworkErrorException
	{
	    ...
	    if (null != authToken) {
		    if (authToken.isEmpty()) {
		        ...
		        if (password != null) {
		            authToken = AccountUtils.mServerAuthenticator.signIn(account.name, password,mContext);
		        }
		    }
	    }
	    ...
	    final Intent intent = new Intent(mContext, LoginActivity2.class);
	    intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
	    intent.putExtra(LoginActivity2.ARG_ACCOUNT_TYPE, account.type);
	    intent.putExtra(LoginActivity2.ARG_AUTH_TOKEN_TYPE, authTokenType);
