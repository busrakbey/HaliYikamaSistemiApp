...
public class MusteriGorevlerimFragment extends Fragment {
    ...
    public void getGorevlerimFromService(Long kullaniciId) throws Exception {
        ...
        Call<String> call = refrofitRestApi.getKullaniciGorevList("hy/process/userTasks/" + kullaniciId, OrtakFunction.authorization, OrtakFunction.tenantId, object.toString());
                        ...
                        mActivity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (Gorevler item : totalGorevList) {
                                    try {
                                        getFormBilgilerimList(item.getId());
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                }
