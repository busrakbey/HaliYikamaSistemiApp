...
abstract public class SwipeToSenkronCallBack extends ItemTouchHelper.Callback {
    ...
    public SwipeToSenkronCallBack(Context context) {
        mContext = context;
        mBackground = new ColorDrawable();
        backgroundColor = Color.parseColor("#159204");
